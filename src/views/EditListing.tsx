  ...
  useEffect(() => {
    if (listing && !isFormInitialized) {
      setFormData({
        ...
        furnished_details: listing.furnished_details || '',
        allows_pets: listing.allows_pets || false,
        pets_details: listing.pets_details || '',
        move_in_immediately: listing.move_in_immediately ?? true,
        // Building & Floor
        ...
        has_rooftop_terrace: listing.has_rooftop_terrace || false,
        has_bbq_area: listing.has_bbq_area || false,
        has_playground: listing.has_playground || false,
        has_waterfront: listing.has_waterfront || false,
        has_view: listing.has_view || false,
        ...
        has_carport: listing.has_carport || false,
        has_ev_charging: listing.has_ev_charging || false,
        has_bicycle_storage: listing.has_bicycle_storage || false,
        has_basement: listing.has_basement || false,
        // Building Amenities
        has_shared_laundry: listing.has_shared_laundry || false,
        has_gym: listing.has_gym || false,
        has_sauna: listing.has_sauna || false,
        has_pool: listing.has_pool || false,
        has_common_room: listing.has_common_room || false,
        has_concierge: listing.has_concierge || false,
        ...
        has_dryer: listing.has_dryer || false,
        // Energy & Comfort
        has_fireplace: listing.has_fireplace || false,
        has_floor_heating: listing.has_floor_heating || false,
        has_district_heating: listing.has_district_heating || false,
        has_heat_pump: listing.has_heat_pump || false,
        has_ventilation: listing.has_ventilation || false,
        has_solar_panels: listing.has_solar_panels || false,
        // Interior Highlights
        has_high_ceilings: listing.has_high_ceilings || false,
        has_large_windows: listing.has_large_windows || false,
        has_smart_home: listing.has_smart_home || false,
        has_built_in_wardrobes: listing.has_built_in_wardrobes || false,
        orientation: listing.orientation || '',
        // Accessibility
        has_step_free_access: listing.has_step_free_access || false,
        has_wheelchair_accessible: listing.has_wheelchair_accessible || false,
        has_wide_doorways: listing.has_wide_doorways || false,
        has_ground_floor_access: listing.has_ground_floor_access || false,
        has_elevator_from_garage: listing.has_elevator_from_garage || false,
        // Safety
        has_secure_entrance: listing.has_secure_entrance || false,
        has_intercom: listing.has_intercom || false,
        has_gated_community: listing.has_gated_community || false,
        has_fire_safety: listing.has_fire_safety || false,
        has_soundproofing: listing.has_soundproofing || false,
        // Building Info
        ...
        utility_cost_estimate: listing.utility_cost_estimate?.toString() || '',
        monthly_expenses: listing.monthly_expenses?.toString() || '',
      });
      ...
      const floorPlanUrlsFromListing = listing.floor_plan_urls || [];
