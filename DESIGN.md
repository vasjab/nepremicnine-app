...
Use this as a reference when building new Next.js projects. It defines the visual language: glassmorphism, color tokens, component patterns, animations, and layout conventions.
