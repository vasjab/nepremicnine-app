  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "fade-out": "fade-out 0.1s cubic-bezier(0.16, 1, 0.3, 1)",
        ...
        "slide-up-spring": "slide-up-spring 0.3s cubic-bezier(0.16, 1, 0.3, 1)",
        "heart-beat": "heart-beat 0.5s cubic-bezier(0.34, 1.56, 0.64, 1)",
